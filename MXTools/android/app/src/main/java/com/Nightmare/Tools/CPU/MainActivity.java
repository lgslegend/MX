package com.Nightmare.Tools.CPU;
...
import com.Nightmare.Tools.CPU.permission.FloatWindowManager;

import java.io.DataOutputStream;

import M.X.R;

public class MainActivity extends BaseFragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView = inflater.inflate(R.layout.cpu1, container,
				false);


        tv1 = (TextView)rootView.findViewById(R.id.mainTextView1);
        tv2 = (TextView)rootView.findViewById(R.id.mainTextView2);
        tv3 = (TextView)rootView.findViewById(R.id.mainTextView3);


        showTextCPU0 = (TextView)rootView.findViewById(R.id.item_cpuTextView1);
        showTextCPU1 = (TextView)rootView.findViewById(R.id.item_cpuTextView2);
        showTextCPU2 = (TextView)rootView.findViewById(R.id.item_cpuTextView3);
        showTextCPU3 = (TextView)rootView.findViewById(R.id.item_cpuTextView4);
        showTextCPU4 = (TextView)rootView.findViewById(R.id.item_cpuTextView5);
        showTextCPU5 = (TextView)rootView.findViewById(R.id.item_cpuTextView6);
        showTextCPU6 = (TextView)rootView.findViewById(R.id.item_cpuTextView7);
        showTextCPU7 = (TextView)rootView.findViewById(R.id.item_cpuTextView8);
		...
		rootView.findViewById(R.id.mainLinearLayout1).setOnClickListener(this);
		rootView.findViewById(R.id.mainLinearLayout2).setOnClickListener(this);
		rootView.findViewById(R.id.mainLinearLayout3).setOnClickListener(this);
		
		final TextView tv = (TextView)rootView.findViewById(R.id.mainTextView);
		tv.setText("隐藏");
		Switch mSwitch = (Switch)rootView.findViewById(R.id.mainSwitch);
		mSwitch.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener(){
				@Override
				public void onCheckedChanged(CompoundButton p1, boolean p2){
					if(p2){
						tv.setText("显示");
						Time_CPU_WindowManager.addBallView(getActivity());
					}else{
						tv.setText("隐藏");
						Time_CPU_WindowManager.removeBallView(getActivity());
					}
				}
			});
		Switch Switch1 =(Switch)rootView.findViewById(R.id.mainSwitch1);
		...
		Switch Switch2 =(Switch)rootView.findViewById(R.id.mainSwitch2);
		...
		Switch Switch3 =(Switch)rootView.findViewById(R.id.mainSwitch3);
		...
		Switch Switch4 =(Switch)rootView.findViewById(R.id.mainSwitch4);
		...
		Switch Switch5 =(Switch)rootView.findViewById(R.id.mainSwitch5);
		...
		Switch Switch6 =(Switch)rootView.findViewById(R.id.mainSwitch6);
		...
		Switch Switch7 =(Switch)rootView.findViewById(R.id.mainSwitch7);
		...
		Switch Switch8 =(Switch)rootView.findViewById(R.id.mainSwitch8);
	...
	private void showSelectCpuCurGov(){
        AlertDialog.Builder cpuCurGovDialog = new AlertDialog.Builder(getActivity());
	...
	private void showSelectCpuMinFreqDialog(){
        AlertDialog.Builder cpuFreqDialog = new AlertDialog.Builder(getActivity());
