...
public class Fragement6_jixian extends BaseFragment {
    @Override  
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  
							 Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fuzhu_jixian, container,  
										 false);
		rootView.findViewById(R.id.fuzhu_jixian).setOnClickListener(new OnClickListener(){
				@Override
