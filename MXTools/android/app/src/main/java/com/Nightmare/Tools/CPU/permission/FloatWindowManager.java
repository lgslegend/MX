package com.Nightmare.Tools.CPU.permission;
...
import com.Nightmare.Tools.CPU.permission.rom.HuaweiUtils;
import com.Nightmare.Tools.CPU.permission.rom.MeizuUtils;
import com.Nightmare.Tools.CPU.permission.rom.MiuiUtils;
import com.Nightmare.Tools.CPU.permission.rom.QikuUtils;
import com.Nightmare.Tools.CPU.permission.rom.RomUtils;
...
public class FloatWindowManager{
    ...
    public static void showConfirmDialog(Context context, String message, final OnConfirmResult result) {
        ...
        dialog = new AlertDialog.Builder(context, R.style.MyAlertDialogStyle).setCancelable(true).setTitle("")
                .setMessage(message)
